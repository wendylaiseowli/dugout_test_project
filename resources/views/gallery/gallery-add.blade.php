...
<html lang="en">
  <head>
    ...
    <title>Add Gallery | The Dugout Oasis Admin Panel</title>
    <!-- CSS -->
    <link
          ...
          <div class="widget-list">
            <div class="row">
              ...
              <div class="col-md-12 widget-holder">
                <div class="widget-bg">
                  <form class="widget-heading clearfix has-validation-callback" action="{{ route('gallerys.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="grey-outline w-100 m-w-100">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-10 btn-list text-center text-md-left">
                          <button class="btn btn-success btn-status-promo" type="submit">Add Item</button>
