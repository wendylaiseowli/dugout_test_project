            ...
            <ul class="nav in side-menu">
              ...
              <li class="current-page menu-item-has-children active">
                <a href="javascript:void(0);"
                  ...
                  <span class="hide-menu small-line dugout-accent-color">Gallery </span></a
                >
                <ul class="list-unstyled sub-menu">
                  <li><a href="{{ route('gallerys.index')}}" class="text-white">Gallery List</a></li>
                </ul>
              </li>
                ...
                <div class="widget-bg">
                  ...
                  <div class="widget-body clearfix">
                    <div class="table-responsive">
                      <table class="table table-editable gallery-table" id="myTable">
                        <!-- data-toggle="datatables" -->
                        <thead>
                          <tr>
                            <th>ID</th>
                            <th class="text-black">Category</th>
                            <th class="text-black" style="width: 30%;">Thumbnail Photo</th>
          ...
          <div id="gallerydetails-modal" class="modal fade show" tabindex="-1" role="dialog" style="display: none;">
            <div class="modal-dialog modal-large">
              <div class="modal-content">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <div class="modal-header">
                  <h5 class="modal-title">Gallery Details</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                  </button>
                </div>
    ...
    <script>
      ...
      document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('export-csv-all').addEventListener('click', function(e) {
          ...
          exportToCSV('gallery-all.csv', data);
        });
