...
<html lang="en">
  <head>
    ...
    <title>Event  | The Dugout Oasis Admin Panel</title>
    <!-- CSS -->
    <link
            ...
            <ul class="nav in side-menu">
              ...
              <li class="current-page menu-item-has-children active">
                <a href="javascript:void(0);"
                  ...
                  <span class="hide-menu small-line dugout-accent-color">Events </span></a
                >
                <ul class="list-unstyled sub-menu">
                  <li><a href="{{ route('events.index')}}" class="text-white">Events List</a></li>
                </ul>
              </li>
                      ...
                      <table class="table table-editable" id="myTable">
                        ...
                        <thead>
                          <tr>
                            ...
                            <th class="text-black">Event Description</th>
                            <th class="text-black">Event Photo</th>
                            <th class="text-black">Event Date</th>
                            <th class="text-black">Event Time</th>
                              ...
                              <tr data-expanded="true">
                                ...
                                <td>
                                  <div class="event-table-image-container">
                                      <img src="{{ asset($event->photo_path) }}" alt="placeholder image">
                                  </div>
                                </td>
    ...
    <script>
      ...
      document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('export-csv-all').addEventListener('click', function(e) {
          ...
          exportToCSV('event-all.csv', data);
        });
