...
<html lang="en">
  <head>
    ...
    <title>Edit Event | The Dugout Oasis Admin Panel</title>
    <!-- CSS -->
    <link
  ...
  <body class="sidebar-dark sidebar-expand navbar-brand-dark header-light">
                    ...
                    <div class="grey-outline w-100 m-w-100">
                      ...
                      <div class="form-group row input-has-value">
                        ...
                        <div class="input-group col-md-10 input-has-value">
                          <input type="text" class="form-control datepicker" placeholder="Pick a Date" data-plugin-options='{"autoclose": true, "format": "dd/mm/yyyy"}' id="event_date" value="{{old('event_date', $event->event_date)->format('d/m/Y')}}" required>
    ...
    <scloudflare.com/ajax/libs/datatables/1.10.15/js/jquery.dataTables.min.js"><ript src="https://cdnjs.cloudflare.com/ajax/libs/datatables/1.10.15/js/jquery.dataTables.min.js"></script>
