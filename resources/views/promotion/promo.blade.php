...
<html lang="en">
  <head>
    ...
    <title>Promotion  | The Dugout Oasis Admin Panel</title>
    <!-- CSS -->
    <link
            ...
            <ul class="nav in side-menu">
              ...
              <li class="current-page menu-item-has-children active">
                <a href="javascript:void(0);"
                  ...
                  <span class="hide-menu small-line dugout-accent-color">Promotions </span></a
                >
                <ul class="list-unstyled sub-menu">
                  <li><a href="{{ route('promotions.index')}}" class="text-white">Promotions List</a></li>
                </ul>
              </li>
                      ...
                      <table class="table table-editable" id="myTable">
                        ...
                        <thead>
                          <tr>
                            ...
                            <th class="text-black">Promotion Name</th>
                            <th class="text-black">Promotion Photo</th>
                            <th class="text-black">Promotion Start Date</th>
                            <th class="text-black">Promotion End Date</th>
                            <th class="text-black">Promotion Description</th>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <div class="userdetail d-flex justify-content-between">
                    ...
                    <div class="form-group input-has-value">
                      <div class="input-group input-has-value">
                        <input type="text" id="promo-start" class="form-control datepicker datepicker-view" readonly> <span class="input-group-addon"><i class="list-icon material-icons">date_range</i></span>
                      </div>
                      <!-- /.input-group -->
                    </div>
                  </div>
                  <div class="userdetail d-flex justify-content-between">
                    ...
                    <div class="form-group input-has-value">
                      <div class="input-group input-has-value">
                        <input type="text" id="promo-end" class="form-control datepicker datepicker-view" readonly> <span class="input-group-addon"><i class="list-icon material-icons">date_range</i></span>
                      </div>
                      <!-- /.input-group -->
                    </div>
                  </div>
    ...
    <script>
      ...
      document.addEventListener('DOMContentLoaded', function() {
        ...
        function exportToPDF(filename, includeAll = true) {
          ...
          // Add title
          doc.setFontSize(16);
          doc.text('Promotions Export', 14, 15);
        ...
        document.getElementById('export-csv-all').addEventListener('click', function(e) {
          ...
          exportToCSV('promotions-all.csv', data);
        });
        ...
        document.getElementById('export-csv-filtered').addEventListener('click', function(e) {
          ...
          exportToCSV('promotions-filtered.csv', data);
        });
        
        // PDF All
        document.getElementById('export-pdf-all').addEventListener('click', function(e) {
          e.preventDefault();
          exportToPDF('promotions-all.pdf', true);
        });
