...
<html lang="en">
  <head>
    ...
    <title>Edit Promotion | The Dugout Oasis Admin Panel</title>
    <!-- CSS -->
    <link
                  ...
                  <form class="widget-heading clearfix has-validation-callback" action="javascript:void(0)" method="get">
                    <div class="grey-outline w-100 m-w-100">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" id="promo-name" type="text" value="Ladies Night" data-validation="required">
                        </div>
                      </div>
                      <!-- <div class="col-lg-12">
                        <div class="form-group">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-10">
                          <textarea class="form-control" id="event-description" rows="10" data-validation="required">Ladies Night every Thursday , house pours are on us! From 8pm to 11pm, indulge in free Whiskey, Gin, Vodka, Tequila or Rum house pours and let the good times flow!
                          *Promo changes weekly</textarea>
                        </div>
                      </div>
                      <div class="form-group row align-items-start">
                        ...
                        <div class="col-md-10">
                          <div class="d-flex flex-column align-items-center align-items-md-start">
                            <!-- Image preview -->
                            <img 
                              src="{{ asset('img/admin/promo/ladies_night.jpg')}}" 
            ...
            <div class="modal-dialog modal-large">
              <div class="modal-content">
                ...
                <form class="form-material" _lpchecked="1">
                  ...
                  <div class="modal-footer">
                    <div class="form-actions d-flex align-items-end">
                      <button class="btn btn-primary btn-oval btn-submit ml-auto  mr-2 btn-edit" type="button">Save</button>
                      <button class="btn btn-outline-default btn-oval btn-cancel btn-black btn-edit" type="button" data-dismiss="modal">Cancel</button>
                    </div>
                  </div>
                </form>
              </div>
