...
<html lang="en">
  ...
  <body class="sidebar-dark sidebar-expand navbar-brand-dark header-light">
          ...
          <div class="widget-list">
            <div class="row">
              ...
              <div class="col-md-12 widget-holder">
                <div class="widget-bg">
                  <form class="widget-heading clearfix has-validation-callback" action="{{ route('promotions.update', $promotion->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="grey-outline w-100 m-w-100">
                      <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" name="name" id="promo-name" type="text" value="{{ old('name',$promotion->name) }}">
                        </div>
                        @error('name')
                          {{ $message }}
                        @enderror
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-10">
                          <textarea class="form-control" id="event-description" rows="10" name="description">{{ old('description',$promotion->description) }}</textarea>
                        </div>
                        @error('description')
                          {{ $message }}
                        @enderror                        
                      ...
                      <div class="form-group row align-items-start">
                        ...
                        <div class="col-md-10">
                          <div class="d-flex flex-column align-items-center align-items-md-start">
                            ...
                            <img 
                              id = "image-preview"
                              src="{{ asset(old('photo_path') ? 'img/admin/promo/'.old('photo_path') : 'img/admin/promo/'.$promotion->photo_path) }}"
                              alt="Ladies Night Image" 
                              class="img-thumbnail mb-3" 
                              style="width: 300px; height: auto;"
                            >

                            <input type="hidden" name="photo_path" id="photo_path" value="{{ old('photo_path', $promotion->photo_path)}}">
    ...
    <script type="text/javascript">
      ...
      //         console.log($(this).val()); // should be like 26/11/2025
      //     });
      // });
