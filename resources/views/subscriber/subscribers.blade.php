...
<html lang="en">
  <head>
    ...
    <title>Subscribers  | The Dugout Oasis Admin Panel</title>
    <!-- CSS -->
    <link
            ...
            <ul class="nav in side-menu">
              ...
              <li class="current-page menu-item-has-children active">
                <a href="javascript:void(0);"
                  ...
                  <span class="hide-menu small-line dugout-accent-color">Subscribers </span></a
                >
                <ul class="list-unstyled sub-menu">
                  <li><a href="{{ route('subscribers.index')}}" class="text-white">Subscribers List</a></li>
                </ul>
              </li>
            </ul>
            <!-- /.side-menu -->
                ...
                <form class="form-material" _lpchecked="1">
                  <div class="modal-body">
                    <div class="row">
                      ...
                      <div class="col-lg-12">
                        <div class="form-group">
                          <input class="form-control" id="user-name" type="text" style="cursor: auto;">
                          <label for="user-name">USERNAME</label>
                        </div>
                      </div>
                      <div class="col-lg-12">
                        <div class="form-group">
                          <input class="form-control" id="email" type="text" style="cursor: auto;">
                      ...
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <input class="form-control" id="last-updated" class="last-update" type="text" style="cursor: auto;">
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="modal-dialog modal-large">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="userdetail d-flex justify-content-between">
                      <p>Last Name:</p>
                      <p class="text-black">Fuhrman</p>
                    </div>
                    <div class="userdetail d-flex justify-content-between">
                      <p>Username:</p>
                      <p class="text-black">High School History Teacher</p>
                    </div>
                    <div class="userdetail d-flex justify-content-between">
                      <p>Email:</p>
