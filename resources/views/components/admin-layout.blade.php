...
<html lang="en">
  <head>
    ...
    <!-- UserBlade, Reservation, MenuBlade, Promo, Gallery -->
    <link
    ...
    <!--Reservation, MenuBlade, MenuAdd, EventAdd, Edit, Promo, PromoAdd, EDit, Gallery-->
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.31/jspdf.plugin.autotable.min.js"></script>
    <!--Menu Add, Edit, Event Add, Edit, PromoAdd, Edit-->
    <link href="https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/3.4.0/fullcalendar.min.css" rel="stylesheet" type="text/css">

    <!--Event-->
    <link href="{{ asset('css/admin/vendors/bootstrap/bootstrap.css')}}" rel="stylesheet" type="text/css" />
                        ...
                        <nav class="sidebar-nav">
                            <ul class="nav in side-menu">
                                ...
                                <li class="menu-item-has-children">
                                    ...
                                    >
                                    <ul class="list-unstyled sub-menu">
                                    <li><a href="{{route('reservation.index')}}">Reservation List</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="menu-item-has-children">
                                    ...
                                    >
                                    <ul class="list-unstyled sub-menu">
                                    <li><a href="{{route('promotion.index')}}">Promotions List</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="menu-item-has-children">
                                    ...
                                    >
                                    <ul class="list-unstyled sub-menu">
                                    <li><a href="{{route('subscribe.index')}}">Subscribers List</a></li>
                                    </ul>
                                </li>
                            </ul>
                                <!-- /.side-menu -->
